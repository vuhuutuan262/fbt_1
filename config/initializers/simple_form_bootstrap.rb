...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: "div", class: "form-group", error_class:
    "has-error" do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :inline_form, tag: "div", class: "form-group", error_class:
    "has-error" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
  ...
  config.wrappers :multi_select, tag: "div", class: "form-group", error_class:
    "has-error" do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: "control-label"
